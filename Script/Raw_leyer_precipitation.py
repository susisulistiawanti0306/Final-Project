...
df = pd.read_csv("E:\SUSI\PELATIHAN\DATA ENGINEER\DIGITALSKOLA\Fineal Project - Susi Sulistiawanti\DATA\CSV\USW00023169-LAS_VEGAS_MCCARRAN_INTL_AP-precipitation-inch.csv")
